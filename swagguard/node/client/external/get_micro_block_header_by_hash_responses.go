...
func (o *GetMicroBlockHeaderByHashOK) GetPayload() *models.MicroBlockHeader {
	return o.Payload
}
...
func (o *GetMicroBlockHeaderByHashBadRequest) GetPayload() *models.Error {
	return o.Payload
}
...
func (o *GetMicroBlockHeaderByHashNotFound) GetPayload() *models.Error {
	return o.Payload
}
