...
func (m *OracleQuery) contextValidateFee(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OracleQuery) contextValidateResponseTTL(ctx context.Context, formats strfmt.Registry) error {
