...
// ContextValidate validates this generic tx based on context it is used
func (m *genericTx) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
