...
func (m *OracleRespondTx) contextValidateFee(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OracleRespondTx) contextValidateResponseTTL(ctx context.Context, formats strfmt.Registry) error {
