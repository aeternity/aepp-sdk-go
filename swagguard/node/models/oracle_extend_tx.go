...
func (m *OracleExtendTx) contextValidateFee(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OracleExtendTx) contextValidateOracleTTL(ctx context.Context, formats strfmt.Registry) error {
