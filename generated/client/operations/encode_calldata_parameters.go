...
func (o *EncodeCalldataParams) WithBody(body *models.ContractCallInput) *EncodeCalldataParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the encode calldata params
func (o *EncodeCalldataParams) SetBody(body *models.ContractCallInput) {
	o.Body = body
}
