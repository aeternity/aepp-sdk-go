	...
	testCases := []struct {
		...
		},
		{
			...
			tx: &ContractCreateTx{
				...
				VMVersion:  4,
				AbiVersion: 1,
				Deposit:    config.Config.Client.Contracts.Deposit,
				Amount:     config.Config.Client.Contracts.Amount,
				GasLimit:   config.Config.Client.Contracts.GasLimit,
				GasPrice:   config.Config.Client.GasPrice,
		...
		},
		{
			...
			tx: &ContractCallTx{
				...
				GasLimit:     config.Config.Client.Contracts.GasLimit,
				GasPrice:     config.Config.Client.GasPrice,
				AbiVersion:   config.Config.Client.Contracts.ABIVersion,
				CallData:     "cb_AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACDiIx1s38k5Ft5Ms6mFe/Zc9A/CVvShSYs/fnyYDBmTRAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACo7j+li",
				Fee:          config.Config.Client.Fee,
				TTL:          config.Config.Client.TTL,
			},
