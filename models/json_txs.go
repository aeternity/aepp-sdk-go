...
// JSONTxs JSON txs
// swagger:model JSONTxs
type JSONTxs struct {

	// transactions
	Transactions []*SignedTxJSON `json:"transactions"`
}

// DataSchema gets the data schema of this subtype
func (m *JSONTxs) DataSchema() string {
	return "JSONTxs"
}

// SetDataSchema sets the data schema of this subtype
func (m *JSONTxs) SetDataSchema(val string) {
...
func (m *JSONTxs) UnmarshalJSON(raw []byte) error {
	var data struct {
...
func (m JSONTxs) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
// Validate validates this JSON txs
func (m *JSONTxs) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *JSONTxs) validateTransactions(formats strfmt.Registry) error {
...
func (m *JSONTxs) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *JSONTxs) UnmarshalBinary(b []byte) error {
	var res JSONTxs
