...
func (m *ChannelCreateTxJSON) DataSchema() string {
	return "ChannelCreateTxJSON"
}

// SetDataSchema sets the data schema of this subtype
func (m *ChannelCreateTxJSON) SetDataSchema(val string) {

}

// Vsn gets the vsn of this subtype
func (m *ChannelCreateTxJSON) Vsn() int64 {
	return m.vsnField
}

// SetVsn sets the vsn of this subtype
func (m *ChannelCreateTxJSON) SetVsn(val int64) {
	m.vsnField = val
}
